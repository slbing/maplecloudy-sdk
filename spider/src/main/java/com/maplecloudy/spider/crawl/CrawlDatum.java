...
import com.maplecloudy.spider.schema.MD5;
...
public class CrawlDatum implements Cloneable {
  ...
  public void clean() {
    ...
    this.score = 0.0f;
    this.signature = null;
    if (this.extend != null) this.extend.clear();
    if (this.extend != null) this.metaData.clear();
  }
  
  public static boolean hasDbStatus(CrawlDatum datum) {
    if (datum.getStatus() <= STATUS_DB_MAX) return true;
    return false;
  }
  ...
  public byte[] getSignature() {
    if (this.signature != null) return this.signature.bytes();
    else return null;
  }
  
  public void setSignature(byte[] signature) {
    if (signature == null) return;
    if (signature != null && signature.length > 256) throw new RuntimeException(
        "Max signature length (256) exceeded: " + signature.length);
    if (this.signature == null)
      this.signature = new com.maplecloudy.spider.schema.MD5();
    this.signature.bytes(signature);
    
  }
  
  public void setMetaData(java.util.Map<String,String> meta) {
    this.metaData = meta;
  }
  ...
  public void setExtendData(java.util.Map<String,String> extend) {
    this.extend = extend;
  }
  ...
  public void putAllMetaData(CrawlDatum other) {
    for (Entry<String,String> e : other.getMetaData().entrySet()) {
      getMetaData().put(e.getKey(), e.getValue());
    }
  }
  
  public void putAllExtendData(CrawlDatum other) {
    for (Entry<String,String> e : other.getExtendData().entrySet()) {
