...
public class GeneratorSmart extends OozieMain implements Tool {
	...
	public static class SelectorInverseMapper extends Mapper<Float, SelectorEntry, String, SelectorEntry> {
		...
		@Override
		protected void map(Float key, SelectorEntry value, Context context) throws IOException, InterruptedException {
	...
	public static void main(String args[]) throws Exception {
		int res = OozieToolRunner.run(SpiderConfiguration.create(), new GeneratorSmart(), args);
		System.exit(res);
	}
