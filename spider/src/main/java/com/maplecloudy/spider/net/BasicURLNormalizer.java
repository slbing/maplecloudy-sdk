...
package com.maplecloudy.spider.net;
...
public class BasicURLNormalizer implements URLNormalizer {
	...
	public BasicURLNormalizer() {
		try {
			...
			adjacentSlashRule.pattern = (Perl5Pattern) compiler.compile(
					"/{2,}", Perl5Compiler.READ_ONLY_MASK);
	...
	private String substituteUnnecessaryRelativePaths(String file) {
		...
		while (oldLen != newLen) {
			...
			// remove leading "/../"
			fileWorkCopy = Util.substitute(matcher,
					leadingRelativePathRule.pattern,
