...
public class UserAgent {
  ...
  private final static String[] userAgentArray = new String[] {"decision-data"};
...
//    };
  private final static String[] phoneAgentArray = new String[] {
  ...
  private static int len = userAgentArray.length;
  ...
  public static String getPhoneAgent() {
    return phoneAgentArray[random.nextInt(len1)];
  }
