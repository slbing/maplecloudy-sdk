 ...
 * @author Susam Pal
 */
public class HttpSimply extends HttpBaseSimply {

	public static final Log LOG = LogFactory.getLog(HttpSimply.class);
	...
	public static void main(String[] args) throws Exception {
		HttpSimply http = new HttpSimply();
		http.setConf(SpiderConfiguration.create());
		main(http, args);
	}
	...
	protected Response getResponse(URL url, CrawlDatum datum, boolean redirect)
		...
		return new HttpResponseSmiply(this, url, datum, redirect);
	}
	...
	private void configureClient() {
		...
		//params.setSoTimeout(timeout); ����������ץ��������ͬtimeout�����£��ܳ�timeout�쳣
