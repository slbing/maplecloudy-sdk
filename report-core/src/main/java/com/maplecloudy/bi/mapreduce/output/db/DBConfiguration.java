...
public class DBConfiguration {
  ...
  public Connection getConnection()
    ...
    System.out.println(DBConfiguration.USERNAME_PROPERTY +": "+conf.get(DBConfiguration.USERNAME_PROPERTY));
    System.out.println(DBConfiguration.URL_PROPERTY +": " + conf.get(DBConfiguration.URL_PROPERTY));
