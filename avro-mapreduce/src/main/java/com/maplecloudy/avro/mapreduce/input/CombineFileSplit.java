...
public class CombineFileSplit extends InputSplit implements Writable {
  ...
  public CombineFileSplit(Configuration job, Path[] files, long[] start,
      long[] lengths, String[] locations) {
    initSplit(job, files, start, lengths, locations);
  }
  
  public CombineFileSplit(Configuration job, Path[] files, long[] lengths) {
  ...
  private void initSplit(Configuration job, Path[] files, long[] start,
      long[] lengths, String[] locations) {
    this.job = job;
